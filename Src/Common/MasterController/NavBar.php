<?php
  function navbar(){
    if(isset($_SESSION['logged'])){
      echo "<a href='/E-Commerce/Src/Common/Login/View/Perfil.php' class='btn btn-dark my-2 my-sm-0 mr-1 ml-1'>Perfil</a>";
      if(isset($_SESSION['adm'])){
        echo "<a href='/E-Commerce/Src/Admin/Estoque/View/' class='btn btn-primary my-2 my-sm-0 mr-1 ml-1'>Estoque</a>";
        echo "<a href='/E-Commerce/Src/Admin/Pedidos/View/Pedidos.php' class='btn btn-success my-2 my-sm-0 mr-1 ml-1'>Pedidos</a>";
      }
